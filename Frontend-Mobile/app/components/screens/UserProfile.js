...
const UserProfile = ({ route, navigation }) => {
    const { fomatTime } = useContext(AuthContext);
    ...
    const ProductIsShow = ({ item }) => {
        return (
            <TouchableOpacity
                ...
                style={{ flexDirection: 'row', padding: 5, borderBottomWidth: 1, borderBottomColor: '#666' }}>
                <Image source={{ uri: UPLOAD_IMAGES_URL + (item.images.length > 0 ? item.images[0].url : 'ok_b7poza') + '.png' }} style={{ flex: 1, resizeMode: 'stretch', height: 80, width: 80 }} />
        ...
        <ScrollView
            ...
            <View style={{ backgroundColor: '#ffffff', padding: 10 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
                    ...
                    <Text style={{ fontSize: 12, marginLeft: 5 }}>95%</Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
            ...
            <View style={{ backgroundColor: '#ffffff', padding: 10, marginTop: 20 }}>
            ...
            {/*                <Rating imageSize={14} startingValue={item.userRatings[0]} readonly />*/}
            {/*                <Text style={{ fontSize: 12, fontWeight: '600', marginLeft: 10 }}>{item.userRatings[0]}</Text>*/}
            {/*            </View>*/}
