...
const AppHeader = ({ style, menu,onSubmit, back,value, onPressBack, title, right, onRightPress, optionalBtn, optionalBtnPress, rightComponent, headerBg = "white", iconColor = 'black', titleAlight, optionalBadge }) => {
	...
	const RightView = () => (
		rightComponent ? rightComponent :
			<View style={[styles.view, styles.rightView]}>
				...
				{right && <TouchableOpacity onPress={() => { onSubmit('keyWord', keyWord, 'keyWord', keyWord) }}>
	...
	return (
		<Surface style={[styles.header,style]}>
			...
			<TextInput value={keyWord} onChangeText={(e)=>setKeyWord(e)} placeholder="Tìm kiếm" />
			<RightView />
		</Surface>
	)
}
